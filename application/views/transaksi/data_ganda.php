...
<body id="page-top">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body p-4" style="margin-top:-35px">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="p-4">
                                        <form class="user" name="frmDataGanda" method="post" target="_blank" action="<?php echo base_url();?>transaksi/export_pdf">                                            
                                            <input type="hidden" name="tipe" id="tipe" value="A">
    ...
    <script>                
        ...
        function cari(){
            ...
            var nik = "";
            var nama = "";
            var url = "<?php echo base_url()?>transaksi/list_data";
        ...
        function exportCSV(){
            ...
            var url = "<?php echo base_url()?>transaksi/exportCSV/"+prov+"/"+kab2+"/"+kec2+"/"+order2+"/"+ket2+"/"+nik2+"/"+nama2;
