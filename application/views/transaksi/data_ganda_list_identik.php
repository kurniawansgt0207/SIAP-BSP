<div class="card-body">
    <div style="margin-top: -10px; margin-bottom: 20px">
        <div class="row">
            <div class="col-lg-6">
                <center><h6>DATA AWAL IDENTIK</h6></center>
            ...
            <div class="col-lg-6">
                <center><h6>DATA PERBAIKAN IDENTIK</h6></center>
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-sm" width="50%" cellspacing="0">
                        <thead>
                            <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo base_url();?>transaksi/rubah_data_ganda/<?php echo $data_ganda->NOMOR_KARTU;?>/IDT" id="ubah<?php echo $data_ganda->NOMOR_KARTU;?>">[Ubah]</a>
                    </td>
                </tr>
                <?php
                    }
